...
<div class="form-group{{ $errors->has('vendor_name') ? ' has-error' : '' }}">
    <label for="vendor_name" class="col-md-4 control-label"><strong class="text-danger">企業/達人 名稱*</strong></label>
    <div class="col-md-12">
...
<div class="form-group">
    <label for="about" class="col-md-4 control-label"><strong class="text-danger">簡介*</strong></label>
    <div class="col-md-12">
...
<div class="form-group">
    ...
    <div class="col-md-12">
        {{ Form::text('address',old('address'),['id'=>'address','class' => 'form-control','required'=>'required']) }}
    </div>
</div>
...
<div class="form-group">
    ...
    <div class="col-md-12">
        {{ Form::text('telephone_number',old('telephone_number'),['id'=>'telephone_number','class' => 'form-control','required'=>'required']) }}
    </div>
</div>
...
<div class="form-group">
    ...
    <div class="col-md-12">
        {{ Form::text('email',old('email'),['id'=>'email','class' => 'form-control','required'=>'required']) }}
    </div>
</div>
...
<div class="form-group">
    ...
    <div class="col-md-12">
        {{ Form::text('line_id',old('website'),['id'=>'line_id','class' => 'form-control']) }}
    </div>
</div>